...
preMaster1 = map(valNob[1][3],0, 1023, 30, 2000);
//preMaster2 = map(valNob[1][3],0, 1023, 255, 0);
...
//aSin2.phMod(preMaster1);
//aTri2.phMod(preMaster1);
//aSaw2.phMod(preMaster1);
//aSqu2.phMod(preMaster1);
...
int asig2 = gain*(lpf.next(((aSin2.next()*sinGain[1]+aTri2.next()*triGain[1]+aSaw2.next()*sawGain[1]+aSqu2.next()*squGain[1])>>3)>>8))>>8;
