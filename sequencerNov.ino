...
curve[0][0] = map(valNob[1][0], 0, 42, 255, 0);
curve[0][1] = map(valNob[1][0], 0, 42, 0, 255);
curve[0][2] = map(valNob[1][0], 43, 84, 255, 0);
...
curve[1][3] = map(valNob[1][1], 43, 84, 0, 255);
curve[1][4] = map(valNob[1][1], 85, 127, 255, 0);
curve[1][5] = map(valNob[1][1], 85, 127, 0, 255);
